...
data = pd.DataFrame({
    ...
    "avg_time": [
        ...
        0.1808, 0.1935, 0.5303, 0.7043, 1.9474, 4.5408,
        1.1916, 2.4662, 3.4602, 4.5976, 11.9005, 22.9965,
        1.0034, 1.6095, 2.5059, 3.353, 6.3413, 12.8095
    ],
    "min_time": [
        0.5350, 1.1257, 2.0636, 2.6060, 10.3648, 22.2233,
        0.1600, 0.1706, 0.4977, 0.5919, 1.5378, 3.2939,
        1.0472, 2.3173, 3.1203, 4.1761, 10.5481, 21.9119,
        0.9585, 1.5799, 2.4739, 3.2335, 6.2362, 12.7103
    ],
    "max_time": [
        1.6564, 2.3309, 4.5693, 5.5394, 13.7755 ,28.2220,
        0.2657, 0.3341, 0.8393, 0.7695, 2.2417, 6.1127,
        1.7473, 2.9097, 4.1065, 5.3150, 13.5455, 24.1683,
        1.0849, 1.6581, 2.5441, 3.4621, 6.5613, 12.9020
    ]
})
